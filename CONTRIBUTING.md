...
```bash
# Clone the repo
git clone https://github.com/XeldarAlz/rigup.git
cd rigup
...
- Use the [bug report template](https://github.com/XeldarAlz/rigup/issues/new?template=bug_report.yml)
- Include your rigup version, Node.js version, and OS
- Include steps to reproduce

## Feature Requests

- Use the [feature request template](https://github.com/XeldarAlz/rigup/issues/new?template=feature_request.yml)
